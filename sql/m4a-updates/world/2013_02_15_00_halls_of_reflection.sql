...
UPDATE `creature_template` SET faction_A = 16, faction_H = 16, equipment_id = 2437 WHERE `entry`=37720; -- Frostsworn General
UPDATE `creature_template` SET faction_A = 1771, faction_H = 1771 WHERE `entry`=37550; -- Raging Ghoul
UPDATE `creature_template` SET faction_A = 1771, faction_H = 1771 WHERE `entry`=37549; -- Lumbering Abomination
UPDATE `creature_template` SET faction_A = 1771, faction_H = 1771 WHERE `entry`=37551; -- Risen Witch Doctor
