...
void AddSC_boss_mimiron()
{
    ...
    {
        Boss_mimiron()
            : CreatureScript("boss_mimiron")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_mimiron(std::move(creature));
        }
    };
    new Boss_mimiron;

    struct Boss_leviathan_mk
        : CreatureScript
    {
        Boss_leviathan_mk()
            : CreatureScript("boss_leviathan_mk")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_leviathan_mk(std::move(creature));
        }
    };
    new Boss_leviathan_mk;

    struct Boss_leviathan_mk_turret
        : CreatureScript
    {
        Boss_leviathan_mk_turret()
            : CreatureScript("boss_leviathan_mk_turret")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_leviathan_mk_turret(std::move(creature));
        }
    };
    new Boss_leviathan_mk_turret;

    struct Mob_proximity_mine
        : CreatureScript
    {
        Mob_proximity_mine()
            : CreatureScript("mob_proximity_mine")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_proximity_mine(std::move(creature));
        }
    };
    ...
    {
        Boss_VX_001()
            : CreatureScript("boss_vx_001")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_vx_001(std::move(creature));
        }
    };
    new Boss_VX_001;
    
    struct Rocket_strike
        : CreatureScript
    {
        Rocket_strike()
            : CreatureScript("rocket_strike")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_rocket_strike(std::move(creature));
        }
    };
    new Rocket_strike;
    
    struct Boss_aerial_unit
        : CreatureScript
    {
        Boss_aerial_unit()
            : CreatureScript("boss_aerial_unit")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_aerial_unit(std::move(creature));
        }
    };
    new Boss_aerial_unit;
    
    struct Magnetic_core
        : CreatureScript
    {
        Magnetic_core()
            : CreatureScript("magnetic_core")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_magnetic_core(std::move(creature));
        }
    };
    new Magnetic_core;
    ...
    {
        Mob_boom_bot()
            : CreatureScript("mob_boom_bot")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_boom_bot(std::move(creature));
        }
    };
    new Mob_boom_bot;
    ...
    {
        Mob_junk_bot()
            : CreatureScript("mob_junk_bot")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_junk_bot(std::move(creature));
        }
    };
    new Mob_junk_bot;
    
    struct Mob_assault_bot
        : CreatureScript
    {
        Mob_assault_bot()
            : CreatureScript("mob_assault_bot")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_assault_bot(std::move(creature));
        }
    };
    new Mob_assault_bot;
    
    struct Mob_emergency_bot
        : CreatureScript
    {
        Mob_emergency_bot()
            : CreatureScript("mob_emergency_bot")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_emergency_bot(std::move(creature));
        }
    };
    new Mob_emergency_bot;
    
    struct Not_push_button
        : GameObjectScript
    {
        Not_push_button()
        ...
        {
            return GOHello_not_push_button(std::move(player), std::move(go));
        }
    };
    new Not_push_button;
    
    struct Mob_mimiron_flame
        : CreatureScript
    {
        Mob_mimiron_flame()
            : CreatureScript("mob_mimiron_flame")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_mimiron_flame(std::move(creature));
        }
    };
    new Mob_mimiron_flame;
    
    struct Mob_frost_bomb
        : CreatureScript
    {
        Mob_frost_bomb()
            : CreatureScript("mob_frost_bomb")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_frost_bomb(std::move(creature));
        }
    };
    new Mob_frost_bomb;
}
