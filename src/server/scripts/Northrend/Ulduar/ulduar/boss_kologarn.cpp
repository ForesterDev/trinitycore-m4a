...
void AddSC_boss_kologarn()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_kologarn(std::move(creature));
        }
    };
    new Boss_kologarn;
    
    struct Mob_focused_eyebeam
        : CreatureScript
    {
        Mob_focused_eyebeam()
            : CreatureScript("mob_focused_eyebeam")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_focused_eyebeam(std::move(creature));
        }
    };
    new Mob_focused_eyebeam;
    
    struct Mob_right_arm
        : CreatureScript
    {
        Mob_right_arm()
            : CreatureScript("mob_right_arm")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_right_arm(std::move(creature));
        }
    };
    new Mob_right_arm;
    ...
    {
        Mob_left_arm()
            : CreatureScript("mob_left_arm")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_left_arm(std::move(creature));
        }
    };
    new Mob_left_arm;
