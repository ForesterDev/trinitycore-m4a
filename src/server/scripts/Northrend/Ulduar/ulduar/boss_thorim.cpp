...
void AddSC_boss_thorim()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_thorim(std::move(creature));
        }
    };
    new Boss_thorim;
    
    struct Mob_pre_phase
        : CreatureScript
    {
        Mob_pre_phase()
            : CreatureScript("mob_pre_phase")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_pre_phase(std::move(creature));
        }
    };
    new Mob_pre_phase;
    
    struct Mob_arena_phase
        : CreatureScript
    {
        Mob_arena_phase()
            : CreatureScript("mob_arena_phase")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_arena_phase(std::move(creature));
        }
    };
    new Mob_arena_phase;
    
    struct Mob_runic_colossus
        : CreatureScript
    {
        Mob_runic_colossus()
            : CreatureScript("mob_runic_colossus")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_runic_colossus(std::move(creature));
        }
    };
    new Mob_runic_colossus;
    
    struct Mob_rune_giant
        : CreatureScript
    {
        Mob_rune_giant()
            : CreatureScript("mob_rune_giant")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_rune_giant(std::move(creature));
        }
    };
    new Mob_rune_giant;
    
    struct Thorim_phase_trigger
        : CreatureScript
    {
        Thorim_phase_trigger()
            : CreatureScript("thorim_phase_trigger")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_thorim_phase_trigger(std::move(creature));
        }
    };
    new Thorim_phase_trigger;
    
    struct Thorim_energy_source
        : CreatureScript
    {
        Thorim_energy_source()
            : CreatureScript("thorim_energy_source")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_thorim_energy_source(std::move(creature));
        }
    };
    ...
    {
        NPC_sif()
            : CreatureScript("npc_sif")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_npc_sif(std::move(creature));
        }
    };
    new NPC_sif;
