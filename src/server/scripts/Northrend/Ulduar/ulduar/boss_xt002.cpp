...
void AddSC_boss_xt002()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_xt002(std::move(creature));
        }
    };
    new Boss_XT002;

    struct Mob_XT002_heart
        : CreatureScript
    {
        Mob_XT002_heart()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_xt002_heart(std::move(creature));
        }
    };
    new Mob_XT002_heart;
        ...
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_scrapbot(std::move(creature));
        }
    };
    new Mob_scrapbot;

    struct Mob_pummeller
        : CreatureScript
    {
        Mob_pummeller()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_pummeller(std::move(creature));
        }
    };
    new Mob_pummeller;
        ...
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_boombot(std::move(creature));
        }
    };
    new Mob_boombot;

    struct Mob_void_zone
        : CreatureScript
    {
        Mob_void_zone()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_void_zone(std::move(creature));
        }
    };
    new Mob_void_zone;

    struct Mob_life_spark
        : CreatureScript
    {
        Mob_life_spark()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_life_spark(std::move(creature));
        }
    };
    new Mob_life_spark;
}
