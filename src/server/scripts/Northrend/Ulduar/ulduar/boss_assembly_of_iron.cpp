...
void AddSC_boss_assembly_of_iron()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_steelbreaker(std::move(creature));
        }
    };
        ...
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_runemaster_molgeim(std::move(creature));
        }
    };
        ...
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_stormcaller_brundir(std::move(creature));
        }
    };
    new Boss_stormcaller_brundir;

    struct Mob_lightning_elemental
        : CreatureScript
    {
        Mob_lightning_elemental()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_lightning_elemental(std::move(creature));
        }
    };
    new Mob_lightning_elemental;

    struct Mob_rune_of_summoning
        : CreatureScript
    {
        Mob_rune_of_summoning()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_rune_of_summoning(std::move(creature));
        }
    };
    new Mob_rune_of_summoning;

    struct Mob_rune_of_power
        : CreatureScript
    {
        Mob_rune_of_power()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_rune_of_power(std::move(creature));
        }
    };
