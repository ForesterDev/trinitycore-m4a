...
void AddSC_boss_general_vezax()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_general_vezax(std::move(creature));
        }
    };
    new Boss_general_vezax;
    
    struct Mob_saronite_vapors
        : CreatureScript
    {
        Mob_saronite_vapors()
            : CreatureScript("mob_saronite_vapors")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_saronite_vapors(std::move(creature));
        }
    };
    new Mob_saronite_vapors;
    
    struct Mob_saronite_animus
        : CreatureScript
    {
        Mob_saronite_animus()
            : CreatureScript("mob_saronite_animus")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_saronite_animus(std::move(creature));
        }
    };
