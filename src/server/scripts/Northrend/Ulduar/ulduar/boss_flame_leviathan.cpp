...
void AddSC_boss_flame_leviathan()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_flame_leviathan(std::move(creature));
        }
    };
    new Boss_flame_leviathan;

    struct Boss_flame_leviathan_seat
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_flame_leviathan_seat(std::move(creature));
        }
    };
    new Boss_flame_leviathan_seat;

    struct Boss_flame_leviathan_defense_turret
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_flame_leviathan_defense_turret(std::move(creature));
        }
    };
    new Boss_flame_leviathan_defense_turret;

    struct Boss_flame_leviathan_overload_device
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_flame_leviathan_overload_device(std::move(creature));
        }
    };
    new Boss_flame_leviathan_overload_device;

    struct Boss_flame_leviathan_safety_container
        : CreatureScript
    {
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_flame_leviathan_safety_containerAI(std::move(creature));
        }
    };
    new Boss_flame_leviathan_safety_container;

    struct Spell_pool_of_tar
        : CreatureScript
    {
        Spell_pool_of_tar()
        ...
        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_spell_pool_of_tar(std::move(creature));
        }
    };
    new Spell_pool_of_tar;
   
    struct NPC_keeper_norgannon
        : CreatureScript
    {
        NPC_keeper_norgannon()
            : CreatureScript("npc_keeper_norgannon")
        {
        }

        bool OnGossipHello(Player *player, Creature *creature)
        {
            return GossipHello_keeper_norgannon(std::move(player), std::move(creature));
        }

        bool OnGossipSelect
            (Player *player, Creature *creature, uint32 sender, uint32 action)
        {
            return GossipSelect_keeper_norgannon(std::move(player), std::move(creature),
                    std::move(sender), std::move(action));
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_keeper_norgannon(std::move(creature));
        }
    };
    ...
    {
        Mob_colossus()
            : CreatureScript("mob_colossus")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_colossus(std::move(creature));
        }
    };
    new Mob_colossus;
    
    struct AT_RX_214_repair_o_matic_station
        : AreaTriggerScript
    {
        ...
        {
            return AreaTrigger_at_RX_214_repair_o_matic_station
                (std::move(player), std::move(trigger));
        }
    };
