...
void AddSC_boss_freya()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_freya(std::move(creature));
        }
    };
    new Boss_freya;
    
    struct Boss_elder_brightleaf
        : CreatureScript
    {
        Boss_elder_brightleaf()
            : CreatureScript("boss_elder_brightleaf")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_elder_brightleaf(std::move(creature));
        }
    };
    new Boss_elder_brightleaf;
        
    struct Creature_unstable_sun_beam
        : CreatureScript
    {
        Creature_unstable_sun_beam()
            : CreatureScript("creature_unstable_sun_beam")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_unstable_sun_beam(std::move(creature));
        }
    };
    new Creature_unstable_sun_beam;

    struct Creature_sun_beam
        : CreatureScript
    {
        Creature_sun_beam()
            : CreatureScript("creature_sun_beam")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_sun_beam(std::move(creature));
        }
    };
    new Creature_sun_beam;
    
    struct Boss_elder_ironbranch
        : CreatureScript
    {
        Boss_elder_ironbranch()
            : CreatureScript("boss_elder_ironbranch")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_elder_ironbranch(std::move(creature));
        }
    };
    new Boss_elder_ironbranch;
    
    struct Creature_iron_roots
        : CreatureScript
    {
        Creature_iron_roots()
            : CreatureScript("creature_iron_roots")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_iron_roots(std::move(creature));
        }
    };
    new Creature_iron_roots;
    
    struct Boss_elder_stonebark
        : CreatureScript
    {
        Boss_elder_stonebark()
            : CreatureScript("boss_elder_stonebark")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_boss_elder_stonebark(std::move(creature));
        }
    };
    new Boss_elder_stonebark;
    
    struct Creature_eonars_gift
        : CreatureScript
    {
        Creature_eonars_gift()
            : CreatureScript("creature_eonars_gift")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_eonars_gift(std::move(creature));
        }
    };
    new Creature_eonars_gift;
    
    struct Creature_nature_bomb
        : CreatureScript
    {
        Creature_nature_bomb()
            : CreatureScript("creature_nature_bomb")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_nature_bomb(std::move(creature));
        }
    };
    new Creature_nature_bomb;
    
    struct Creature_detonating_lasher
        : CreatureScript
    {
        Creature_detonating_lasher()
            : CreatureScript("creature_detonating_lasher")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_detonating_lasher(std::move(creature));
        }
    };
    new Creature_detonating_lasher;
    
    struct Creature_ancient_conservator
        : CreatureScript
    {
        Creature_ancient_conservator()
            : CreatureScript("creature_ancient_conservator")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_ancient_conservator(std::move(creature));
        }
    };
    new Creature_ancient_conservator;
    
    struct Creature_healthy_spore
        : CreatureScript
    {
        Creature_healthy_spore()
            : CreatureScript("creature_healthy_spore")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_healthy_spore(std::move(creature));
        }
    };
    new Creature_healthy_spore;
    
    struct Creature_storm_lasher
        : CreatureScript
    {
        Creature_storm_lasher()
            : CreatureScript("creature_storm_lasher")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_storm_lasher(std::move(creature));
        }
    };
    new Creature_storm_lasher;

    struct Creature_snaplasher
        : CreatureScript
    {
        Creature_snaplasher()
            : CreatureScript("creature_snaplasher")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_snaplasher(std::move(creature));
        }
    };
    new Creature_snaplasher;

    struct Creature_ancient_water_spirit
        : CreatureScript
    {
        Creature_ancient_water_spirit()
            : CreatureScript("creature_ancient_water_spirit")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_creature_ancient_water_spirit(std::move(creature));
        }
    };
