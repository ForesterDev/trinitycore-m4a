...
void AddSC_boss_auriaya()
{
        ...
        : CreatureScript
    {
        ...
        {
            return GetAI_boss_auriaya(std::move(creature));
        }
    };
    new Boss_auriaya;
    
    struct Feral_defender_trigger
        : CreatureScript
    {
        Feral_defender_trigger()
            : CreatureScript("feral_defender_trigger")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_feral_defender_trigger(std::move(creature));
        }
    };
    new Feral_defender_trigger;
    
    struct Mob_sanctum_sentry
        : CreatureScript
    {
        Mob_sanctum_sentry()
            : CreatureScript("mob_sanctum_sentry")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_sanctum_sentry(std::move(creature));
        }
    };
    new Mob_sanctum_sentry;
    
    struct Mob_feral_defender
        : CreatureScript
    {
        Mob_feral_defender()
            : CreatureScript("mob_feral_defender")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_mob_feral_defender(std::move(creature));
        }
    };
    new Mob_feral_defender;
    
    struct Seeping_trigger
        : CreatureScript
    {
        Seeping_trigger()
            : CreatureScript("seeping_trigger")
        {
        }

        CreatureAI *GetAI(Creature *creature) const
        {
            return GetAI_seeping_trigger(std::move(creature));
        }
    };
    new Seeping_trigger;
}
