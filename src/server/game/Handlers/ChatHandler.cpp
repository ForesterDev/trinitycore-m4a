    ...
    switch (type)
    {
        ...
        case CHAT_MSG_YELL:
        {
          if (AccountMgr::IsPlayerAccount(GetSecurity()))
            ...
            {
                ChatHandler(this).PSendSysMessage(GetTrinityString(LANG_SAY_REQ), sWorld->getIntConfig(CONFIG_CHAT_SAY_LEVEL_REQ));
                return;
            }
        ...
        case CHAT_MSG_WHISPER:
        {
            if (AccountMgr::IsPlayerAccount(GetSecurity()))
              ...
              {
                  ChatHandler(this).PSendSysMessage(GetTrinityString(LANG_WHISPER_REQ), sWorld->getIntConfig(CONFIG_CHAT_WHISPER_LEVEL_REQ));
                  return;
              }
        ...
        case CHAT_MSG_CHANNEL:
        {
            if (AccountMgr::IsPlayerAccount(GetSecurity()))
            {
                ...
                {
                    ChatHandler(this).PSendSysMessage(GetTrinityString(LANG_CHANNEL_REQ), sWorld->getIntConfig(CONFIG_CHAT_CHANNEL_LEVEL_REQ));
                    return;
                }
            }
