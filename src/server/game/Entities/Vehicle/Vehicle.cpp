...
void Vehicle::Uninstall()
{
    ...
    sLog->outDebug(LOG_FILTER_VEHICLES, "Vehicle::Uninstall Entry: %u", _creatureEntry);
    RemoveAllPassengers();
...
{
    sLog->outDebug(LOG_FILTER_VEHICLES, "Vehicle::RemoveAllPassengers. Entry: %u", _creatureEntry);
